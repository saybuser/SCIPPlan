...
![alt text](./scipplan_navigation.png)
Figure 1: Visualization of a plan generated by SCIPPlan [1,2] for the example navigation domain where the red square represents the agent, the blue square represents the block, gold star represents the goal location and delta represents the wall-clock.
